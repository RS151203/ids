...
################################################################################
## Form generated from reading UI file 'ids2.ui'
##
...
import ids_resource_rc

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        if not MainWindow.objectName():
            MainWindow.setObjectName(u"MainWindow")
        MainWindow.resize(1632, 906)
        icon = QIcon()
        icon.addFile(u"../GUI/Users/Jhonatan Deni/.designer/Jhonatan Deni/.designer/backup/src/home.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QRect(0, 0, 1546, 874))
        ...
        self.scrollAreaWidgetContents_9.setGeometry(QRect(0, 0, 1486, 874))
...
"")
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 1458, 533))
...
"")
        ...
        self.frame_41.setGeometry(QRect(10, 420, 621, 121))
        ...
        self.change_password_button = QPushButton(self.frame_99)
        self.change_password_button.setObjectName(u"change_password_button")

        self.horizontalLayout_110.addWidget(self.change_password_button)
        ...
        self.frame_106 = QFrame(self.page_6)
        self.frame_106.setObjectName(u"frame_106")
        self.frame_106.setGeometry(QRect(10, 20, 621, 151))
...
"color: rgb(255, 255, 255);")
        ...
        self.frame_109 = QFrame(self.page_6)
        self.frame_109.setObjectName(u"frame_109")
        self.frame_109.setGeometry(QRect(10, 210, 621, 171))
        self.frame_109.setStyleSheet(u"background-color:rgba(255,255,255,30);")
        self.frame_109.setFrameShape(QFrame.StyledPanel)
        self.frame_109.setFrameShadow(QFrame.Raised)
        self.verticalLayout_123 = QVBoxLayout(self.frame_109)
        self.verticalLayout_123.setSpacing(10)
        self.verticalLayout_123.setObjectName(u"verticalLayout_123")
        self.label_114 = QLabel(self.frame_109)
        self.label_114.setObjectName(u"label_114")
        self.label_114.setMaximumSize(QSize(16777215, 40))

        self.verticalLayout_123.addWidget(self.label_114)

        self.email_address_area = QTextEdit(self.frame_109)
        self.email_address_area.setObjectName(u"email_address_area")

        self.verticalLayout_123.addWidget(self.email_address_area)

        self.frame_110 = QFrame(self.frame_109)
        self.frame_110.setObjectName(u"frame_110")
        self.frame_110.setStyleSheet(u"background-color:rgba(255,255,255,0);")
        self.frame_110.setFrameShape(QFrame.StyledPanel)
        self.frame_110.setFrameShadow(QFrame.Raised)
        self.verticalLayout_125 = QVBoxLayout(self.frame_110)
        ...
        self.horizontalSpacer_41 = QSpacerItem(70, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.horizontalLayout_123.addItem(self.horizontalSpacer_41)

        self.add_email_address_button = QPushButton(self.frame_111)
        self.add_email_address_button.setObjectName(u"add_email_address_button")

        self.horizontalLayout_123.addWidget(self.add_email_address_button)

        self.horizontalSpacer_42 = QSpacerItem(70, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.horizontalLayout_123.addItem(self.horizontalSpacer_42)


        self.verticalLayout_125.addWidget(self.frame_111)


        self.verticalLayout_123.addWidget(self.frame_110)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" color:#ffffff;\">Change Password</span></p></body></html>", None))
        self.change_password_button.setText(QCoreApplication.translate("MainWindow", u"Click Here", None))
        ...
        self.label_114.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" color:#ffffff;\">Alert Email</span></p></body></html>", None))
        self.email_address_area.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Add emails for sending alerts seperated by commas", None))
        self.add_email_address_button.setText(QCoreApplication.translate("MainWindow", u"Add", None))
    # retranslateUi
